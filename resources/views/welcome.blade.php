...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('cssfolder/mainnavbar.css?v=2R') }}">
  <link rel="stylesheet" href="{{ asset('cssfolder/contacts.css?v=2R') }}" />
  <link rel="stylesheet" href="{{ asset('cssfolder/carousel.css?v=2R') }}" />
